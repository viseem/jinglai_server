...
/**
 * 客户发票 Base VO，提供给添加、修改、详细的子 VO 使用
 * 如果子 VO 存在差异的字段，请不要添加到这里，影响 Swagger 文档生成
 */
@Data
public class CrmReceiptBaseVO {
    ...
    @Schema(description = "客户id", requiredMode = Schema.RequiredMode.REQUIRED, example = "24061")
    @NotNull(message = "客户id不能为空")
    private Long customerId;

    @Schema(description = "合同id", requiredMode = Schema.RequiredMode.REQUIRED, example = "7977")
    ...
    @Schema(description = "开票金额", requiredMode = Schema.RequiredMode.REQUIRED, example = "27166")
