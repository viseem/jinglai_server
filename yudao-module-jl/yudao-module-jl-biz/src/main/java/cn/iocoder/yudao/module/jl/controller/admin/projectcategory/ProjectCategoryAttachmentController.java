...
public class ProjectCategoryAttachmentController {
    ...
    @Operation(summary = "通过 ID 删除项目实验名目的附件")
    ...
    @GetMapping("/get")
    @Operation(summary = "通过 ID 获得项目实验名目的附件")
    ...
    @Operation(summary = "导出项目实验名目的附件 Excel")
    ...
    public void exportProjectCategoryAttachmentExcel(@Valid ProjectCategoryAttachmentExportReqVO exportReqVO, HttpServletResponse response) throws IOException {
        ...
        ExcelUtils.write(response, "项目实验名目的附件.xls", "数据", ProjectCategoryAttachmentExcelVO.class, excelData);
    }
