...
-- 项目采购单申请表
-- ----------------------------
-- Table structure for jl_project_supply_procurement
-- ----------------------------
...
-- 项目采购单申请明细表
-- ----------------------------
-- Table structure for jl_project_supply_procurement_item
-- ----------------------------
...
-- 项目采购单打款表
-- ----------------------------
-- Table structure for jl_project_supply_procurement_payment
-- ----------------------------
...
-- 采购供货商表
-- ----------------------------
-- Table structure for jl_project_supply_procurement_shipment
-- ----------------------------
...
-- 库管项目物资库存变更日志表
-- ----------------------------
-- Table structure for jl_inventory_project_supply_log
-- ----------------------------
...
(
  ...
  AUTO_INCREMENT = 1
  DEFAULT CHARSET = utf8mb4
  COLLATE = utf8mb4_unicode_ci COMMENT ='库管项目物资库存变更日志表';

-- 库管项目物资库存变更日志附件表
-- ----------------------------
-- Table structure for jl_inventory_project_supply_log_attachment
-- ----------------------------
...
-- 库管项目物资库存变更日志明细表
-- ----------------------------
-- Table structure for jl_inventory_project_supply_log_item
-- ----------------------------
